...
public class DashboardController implements SimulationListener {
    ...
    if (type == HabitatType.AQUATIC) {
        try {
            Image frogImage = new Image(
                getClass().getResourceAsStream("/com/crittercare/images/CorallCrab.gif")
            );
            ImageView iv = new ImageView(frogImage);
            iv.setFitWidth(32);
            iv.setFitHeight(32);
    ...
    if (type == HabitatType.SAVANNAH) {
        try {
            Image frogImage = new Image(
                getClass().getResourceAsStream("/com/crittercare/images/SpikeyPorcupine.gif")
            );
            ImageView iv = new ImageView(frogImage);
            iv.setFitWidth(32);
            iv.setFitHeight(32);
